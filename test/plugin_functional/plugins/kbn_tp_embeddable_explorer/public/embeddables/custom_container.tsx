...
import { Container, Embeddable, TimeRange, ViewMode } from 'plugins/embeddable_api';
import { ContainerInput } from 'plugins/embeddable_api';
import { ContainerOutput } from 'plugins/embeddable_api';
import { ErrorEmbeddable, isErrorEmbeddable } from 'plugins/embeddable_api';
...
export class CustomContainer extends Container<ContainerInput, ContainerOutput, EmbeddableInput> {
  ...
  public setEmbeddables(
    ...
    if (!isErrorEmbeddable(embeddable1)) {
      embeddable1.setInput(this.getInputForEmbeddable());
    }

    if (!isErrorEmbeddable(embeddable2)) {
      embeddable2.setInput(this.getInputForEmbeddable());
    }
  }
